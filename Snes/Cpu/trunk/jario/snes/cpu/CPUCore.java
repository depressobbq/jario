...
public abstract class CPUCore
{
    ...
    public CPUCoreOp op_adc_b = new CPUCoreOp() {
    ...
    public CPUCoreOp op_adc_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int result;
    ...
    public CPUCoreOp op_and_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_and_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_bit_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_bit_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_cmp_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int r = regs.a.l() - rd.l();
        regs.p.n = (r & 0x80) != 0;
    ...
    public CPUCoreOp op_cmp_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int r = regs.a.w() - rd.w();
        regs.p.n = (r & 0x8000) != 0;
    ...
    public CPUCoreOp op_cpx_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int r = regs.x.l() - rd.l();
        regs.p.n = (r & 0x80) != 0;
    ...
    public CPUCoreOp op_cpx_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int r = regs.x.w() - rd.w();
        regs.p.n = (r & 0x8000) != 0;
    ...
    public CPUCoreOp op_cpy_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int r = regs.y.l() - rd.l();
        regs.p.n = (r & 0x80) != 0;
    ...
    public CPUCoreOp op_cpy_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int r = regs.y.w() - rd.w();
        regs.p.n = (r & 0x8000) != 0;
    ...
    public CPUCoreOp op_eor_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.a.l(regs.a.l() ^ rd.l());
        regs.p.n = (regs.a.l() & 0x80) != 0;
    ...
    public CPUCoreOp op_eor_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.a.w(regs.a.w() ^ rd.w());
        regs.p.n = (regs.a.w() & 0x8000) != 0;
    ...
    public CPUCoreOp op_lda_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.a.l(rd.l());
        regs.p.n = (regs.a.l() & 0x80) != 0;
    ...
    public CPUCoreOp op_lda_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.a.w(rd.w());
        regs.p.n = (regs.a.w() & 0x8000) != 0;
    ...
    public CPUCoreOp op_ldx_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.x.l(rd.l());
    ...
    public CPUCoreOp op_ldx_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.x.w(rd.w());
    ...
    public CPUCoreOp op_ldy_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.y.l(rd.l());
    ...
    public CPUCoreOp op_ldy_w= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.y.w(rd.w());
    ...
    public CPUCoreOp op_ora_b= new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.a.l(regs.a.l() | rd.l());
        regs.p.n = (regs.a.l() & 0x80) != 0;
    ...
    public CPUCoreOp op_ora_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.a.w(regs.a.w() | rd.w());
        regs.p.n = (regs.a.w() & 0x8000) != 0;
    ...
    public CPUCoreOp op_sbc_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int result;
        rd.l(rd.l() ^ 0xff);
    ...
    public CPUCoreOp op_sbc_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int result;
        rd.w(rd.w() ^ 0xffff);
    ...
    public CPUCoreOp op_inc_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.l(rd.l() + 1);
        regs.p.n = (rd.l() & 0x80) != 0;
    ...
    public CPUCoreOp op_inc_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.w(rd.w() + 1);
        regs.p.n = (rd.w() & 0x8000) != 0;
    ...
    public CPUCoreOp op_dec_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.l(rd.l() - 1);
        regs.p.n = (rd.l() & 0x80) != 0;
    ...
    public CPUCoreOp op_dec_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.w(rd.w() - 1);
        regs.p.n = (rd.w() & 0x8000) != 0;
    ...
    public CPUCoreOp op_asl_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_asl_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_lsr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.p.c = (rd.l() & 1) != 0;
        rd.l(rd.l() >> 1);
    ...
    public CPUCoreOp op_lsr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.p.c = (rd.w() & 1) != 0;
        rd.w(rd.w() >> 1);
    ...
    public CPUCoreOp op_rol_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_rol_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int carry = regs.p.c ? 1 : 0;
        regs.p.c = (rd.w() & 0x8000) != 0;
    ...
    public CPUCoreOp op_ror_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_ror_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_trb_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.p.z = (rd.l() & regs.a.l()) == 0;
        rd.l(rd.l() & (~regs.a.l()));
    ...
    public CPUCoreOp op_trb_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.p.z = (rd.w() & regs.a.w()) == 0;
        rd.w(rd.w() & (~regs.a.w()));
    ...
    public CPUCoreOp op_tsb_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.p.z = (rd.l() & regs.a.l()) == 0;
        rd.l(rd.l() | regs.a.l());
    ...
    public CPUCoreOp op_tsb_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.p.z = (rd.w() & regs.a.w()) == 0;
        rd.w(rd.w() | regs.a.w());
    ...
    public CPUCoreOp op_read_const_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_read_const_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        rd.l(op_readpc());
    ...
    public CPUCoreOp op_read_bit_const_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        rd.l(op_readpc());
    ...
    public CPUCoreOp op_read_bit_const_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.l(op_readpc());
        last_cycle();
    ...
    public CPUCoreOp op_read_addr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_addr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_addrx_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_addrx_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_addry_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_addry_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_long_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_long_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_longx_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_longx_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_read_dp_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_dp_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_dpr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        int n = args.x;
    ...
    public CPUCoreOp op_read_dpr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        int n = args.x;
    ...
    public CPUCoreOp op_read_idp_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_idp_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_idpx_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_idpx_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_idpy_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_idpy_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_ildp_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_ildp_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_ildpy_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_ildpy_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_read_sr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        sp = op_readpc();
    ...
    public CPUCoreOp op_read_sr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        sp = op_readpc();
    ...
    public CPUCoreOp op_read_isry_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        sp = op_readpc();
    ...
    public CPUCoreOp op_read_isry_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        sp = op_readpc();
    ...
    public CPUCoreOp op_write_addr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_write_addr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_write_addrr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        int i = args.y;
    ...
    public CPUCoreOp op_write_addrr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        int i = args.y;
    ...
    public CPUCoreOp op_write_longr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int i = args.x;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_write_longr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int i = args.x;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_write_dp_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        dp = op_readpc();
    ...
    public CPUCoreOp op_write_dp_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        dp = op_readpc();
    ...
    public CPUCoreOp op_write_dpr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        int i = args.y;
    ...
    public CPUCoreOp op_write_dpr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        int i = args.y;
    ...
    public CPUCoreOp op_sta_idp_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_idp_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_ildp_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_ildp_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_idpx_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_idpx_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_idpy_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_idpy_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_ildpy_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_ildpy_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_sta_sr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        sp = op_readpc();
        op_io();
    ...
    public CPUCoreOp op_sta_sr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        sp = op_readpc();
        op_io();
    ...
    public CPUCoreOp op_sta_isry_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        sp = op_readpc();
        op_io();
    ...
    public CPUCoreOp op_sta_isry_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        sp = op_readpc();
        op_io();
    ...
    public CPUCoreOp op_adjust_imm_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        int adjust = args.y;
    ...
    public CPUCoreOp op_adjust_imm_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        int adjust = args.y;
    ...
    public CPUCoreOp op_asl_imm_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_asl_imm_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_lsr_imm_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_lsr_imm_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_rol_imm_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_rol_imm_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_ror_imm_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_ror_imm_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_adjust_addr_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_adjust_addr_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_adjust_addrx_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_adjust_addrx_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        aa.l(op_readpc());
    ...
    public CPUCoreOp op_adjust_dp_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_adjust_dp_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_adjust_dpx_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_adjust_dpx_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        CPUCoreOp op = args.op;
        dp = op_readpc();
    ...
    public CPUCoreOp op_branch = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int bit = args.x;
        int val = args.y;
    ...
    public CPUCoreOp op_bra = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.l(op_readpc());
        aa.w(regs.pc.get() + (byte)rd.l());
    ...
    public CPUCoreOp op_brl = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.l(op_readpc());
        rd.h(op_readpc());
    ...
    public CPUCoreOp op_jmp_addr = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.l(op_readpc());
        last_cycle();
    ...
    public CPUCoreOp op_jmp_long = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        rd.l(op_readpc());
        rd.h(op_readpc());
    ...
    public CPUCoreOp op_jmp_iaddr = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_jmp_iaddrx = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_jmp_iladdr = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_jsr_addr = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_jsr_long_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_jsr_long_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_jsr_iaddrx_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        op_writestackn(regs.pc.h());
    ...
    public CPUCoreOp op_jsr_iaddrx_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        op_writestackn(regs.pc.h());
    ...
    public CPUCoreOp op_rti_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_rti_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_rts = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_rtl_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_rtl_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_nop = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_wdm = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_readpc();
    ...
    public CPUCoreOp op_xba = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        last_cycle();
    ...
    public CPUCoreOp op_move_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int adjust = args.x;
        dp = op_readpc();
    ...
    public CPUCoreOp op_move_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int adjust = args.x;
        dp = op_readpc();
    ...
    public CPUCoreOp op_interrupt_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int vectorE = args.x;
        op_readpc();
    ...
    public CPUCoreOp op_interrupt_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int vectorN = args.y;
        op_readpc();
    ...
    public CPUCoreOp op_stp = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.wai = true;
        while (regs.wai)
    ...
    public CPUCoreOp op_wai = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        regs.wai = true;
        while (regs.wai)
    ...
    public CPUCoreOp op_xce = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_flag = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int mask = args.x;
        int value = args.y;
    ...
    public CPUCoreOp op_pflag_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    ...
    public CPUCoreOp op_pflag_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
    	boolean mode = args.x != 0;
        rd.l(op_readpc());
    ...
    public CPUCoreOp op_transfer_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int from = args.x;
        int to = args.y;
    ...
    public CPUCoreOp op_transfer_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int from = args.x;
        int to = args.y;
    ...
    public CPUCoreOp op_tcs_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_tcs_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_tsx_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_tsx_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_txs_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_txs_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        last_cycle();
        op_io_irq();
    ...
    public CPUCoreOp op_push_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        op_io();
    ...
    public CPUCoreOp op_push_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        op_io();
    ...
    public CPUCoreOp op_phd_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
    ...
    public CPUCoreOp op_phd_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_writestackn(regs.d.h());
    ...
    public CPUCoreOp op_phb = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        last_cycle();
    ...
    public CPUCoreOp op_phk = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        last_cycle();
    ...
    public CPUCoreOp op_php = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        last_cycle();
    ...
    public CPUCoreOp op_pull_b = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        op_io();
    ...
    public CPUCoreOp op_pull_w = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        int n = args.x;
        op_io();
    ...
    public CPUCoreOp op_pld_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_pld_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_plb = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_plp_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_plp_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        op_io();
        op_io();
    ...
    public CPUCoreOp op_pea_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_pea_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_pei_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_pei_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        dp = op_readpc();
        op_io_cond2();
    ...
    public CPUCoreOp op_per_e = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    public CPUCoreOp op_per_n = new CPUCoreOp() {
    	public void Invoke(CPUCoreOpArgument args)
    {
        aa.l(op_readpc());
        aa.h(op_readpc());
    ...
    protected void update_table()
    {
        if (regs.e)
        {
        	opcode_table = Arrays.asList(op_table).subList(Table_EM, Table_EM + (op_table.length - Table_EM));
        }
        else if (regs.p.m)
        {
            if (regs.p.x)
            {
                opcode_table = Arrays.asList(op_table).subList(Table_MX, Table_MX + (op_table.length - Table_MX));
            }
            else
            {
                opcode_table = Arrays.asList(op_table).subList(Table_Mx, Table_Mx + (op_table.length - Table_Mx));
