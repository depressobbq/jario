...
public class Screen
{
    ...
    private final int get_pixel(boolean swap)
    {
        ...
        {
        	int temp;
            temp = priority_main; priority_main = priority_sub; priority_sub = temp;
            temp = color_main; color_main = color_sub; color_sub = temp;
            temp = source_main; source_main = source_sub; source_sub = temp;
        }
        ...
        {
            if (!self.window.output_sub_color_enable)
            {
                return 0x0000;
            }
            color_main = 0x0000;
