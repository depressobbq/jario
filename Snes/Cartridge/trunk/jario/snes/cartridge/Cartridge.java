...
public class Cartridge implements Hardware, Bus8bit, Configurable
{
    ...
    public enum Mode { Normal, BsxSlotted, Bsx, SufamiTurbo, SuperGameBoy }
    public enum Region { NTSC, PAL }
    public enum MapMode { Direct, Linear, Shadow }
    ...
    public int getRamSize() { return ram_size; }
	...
	public Object readConfig(String key)
	{
		switch (key)
		{
			case "region": return region.name().toLowerCase();
		}
		return null;
	}
