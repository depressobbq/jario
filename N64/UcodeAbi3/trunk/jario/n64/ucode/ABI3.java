...
public class ABI3 extends ABI1
{
	...
	protected OpCode SETVOL3 = new OpCode()
	{
	...
	protected OpCode ENVMIXER3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
			int flags = (inst1 >>> 16) & 0xFF;
	...
	protected OpCode CLEARBUFF3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode MIXER3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode LOADBUFF3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
			int cnt = ((inst1 >>> 0xC) + 3) & 0xFFC;
			int v0 = inst2 & 0xFFFFFC;
			rdramDMA.readDMA(v0, BufferSpace, (inst1 & 0xFFC) + 0x4F0, cnt);
		}
	};

	protected OpCode SAVEBUFF3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
			int cnt = (((inst1 >>> 0xC) + 3) & 0xFFC);
			int v0 = inst2 & 0xFFFFFC;
			rdramDMA.writeDMA(v0, BufferSpace, (inst1 & 0xFFC) + 0x4F0, cnt);
		}
	};

	protected OpCode LOADADPCM3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode DMEMMOVE3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode SETLOOP3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode ADPCM3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode RESAMPLE3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode INTERLEAVE3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode WHATISTHIS = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode MP3ADDY = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode MP3 = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
	...
	protected OpCode DISABLE = new OpCode()
	{
		public void exec(int inst1, int inst2)
		{
