...
public class L3dex extends F3dex
{
	...
	protected OpCode L3DEX_Line3D = new OpCode()
	{
		public void exec(int w0, int w1)
		{
			int wd = w1 & Gbi.SR_MASK_8;
			if (wd == 0)
				gSPLine3D((w1 >> 17) & Gbi.SR_MASK_7, (w1 >> 9) & Gbi.SR_MASK_7, 0);
			else
				gSPLineW3D((w1 >> 17) & Gbi.SR_MASK_7, (w1 >> 9) & Gbi.SR_MASK_7, wd, 0);
		}
	};
}
