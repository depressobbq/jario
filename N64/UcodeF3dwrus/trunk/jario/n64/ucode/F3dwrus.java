...
{
	protected static final int F3DWRUS_TRI2 = 0xB1;
	...
	public void clock(long ticks)
	{
		...
		dlist[0xB5] = F3DWRUS_Quad;
		dlist[0xB4] = F3D_RDPHalf_1;
		dlist[0xB3] = F3D_RDPHalf_2;
		dlist[0xB2] = F3D_RDPHalf_Cont;
		dlist[0xB1] = F3DWRUS_Tri2;
	}

	/************************* OpCode functions *************************/

	protected OpCode F3DWRUS_Vtx = new OpCode()
	{
	...
	protected OpCode F3DWRUS_Tri1 = new OpCode()
	{
		public void exec(int w0, int w1)
		{
		}
	...
	protected OpCode F3DWRUS_Tri2 = new OpCode()
	{
		public void exec(int w0, int w1)
		{
		}
	...
	protected OpCode F3DWRUS_Quad = new OpCode()
	{
		public void exec(int w0, int w1)
		{
		}
